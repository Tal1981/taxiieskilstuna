    ...
    return(
        <form className={`max-w-md mx-auto mt-6 ${tabActive === "Boka" ? "block":"hidden"}`} onSubmit={handleSubmit} >
            ...
            <div className="grid md:grid-cols-1">
                <label htmlFor="datetime" className="text-sm mb-1 tracking-wide">Bokningstid</label>
                <div className="relative z-0 w-full mb-5 group h-10    block py-2.5 px-1 text-sm bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer active:outline-none">
                    <FlatpickrComp/>
                </div>
            </div>
